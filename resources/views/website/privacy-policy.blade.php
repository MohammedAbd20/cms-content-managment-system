        ...
        <section class="pxa_pages">
            <div class="pxa_container">
                ...
                <ul>
                    ...
                    <li>
                        <p class="">Definition of key terms used throughout the document. It is a long established
                            fact that a reader
                ...
                <h5 class="">Acceptance of Terms</h5>
                <ul>
                    <li>
                        <p class="">Explanation of how users accept the terms (e.g., by using the website or service).
                            It is a long
                    ...
                    <li>
                        <p class="">Details on the age requirement for users. It is a long established fact that a
                            reader will be
                ...
                <h5 class="">User Accounts and Registration</h5>
                <ul>
                    <li>
                        <p class="">Information on the registration process. It is a long established fact that a
                            reader will be
                            distracted by the readable content of a page when looking at its layout. The point of using
                            Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using
                            'Content here, content here', making it look like readable English. Many desktop publishing
                    ...
                    <li>
                        <p class="">Responsibilities of users regarding account information. It is a long established
                            fact that a
                            reader will be distracted by the readable content of a page when looking at its layout. The
                            point of using Lorem Ipsum is that it has a more-or-less normal distribution of letters, as
                            opposed to using 'Content here, content here', making it look like readable English. Many
                ...
                <h5 class="">Use of the Service</h5>
                <ul>
                    <li>
                        <p class="">Description of the services provided. It is a long established fact that a reader
                            will be
                            distracted by the readable content of a page when looking at its layout. The point of using
                            Lorem Ipsum is that it has a more-or-less normal distribution of letters, as opposed to using
                            'Content here, content here', making it look like readable English. Many desktop publishing
                    ...
                    <li>
                        <p class="">Acceptable use policy. It is a long established fact that a reader will be
                            distracted by the
                ...
                <h5 class="">Ownership of content.</h5>
                <ul>
                    <li>
                        <p class="">User-generated content guidelines. It is a long established fact that a reader
                            will be distracted
                    ...
                    <li>
                        <p class="">Intellectual property rights. It is a long established fact that a reader will be
                            distracted by
